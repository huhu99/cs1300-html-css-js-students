...
const updatePage = async () => {
  ...
  const filteredArray = fruitsArray.filter(function(f) {
    return f.nutritions.sugar > 10;
  })

  // TODO: Create a new HTML element to display your data
  const fruitNames = filteredArray.map(f => f.name)

  // TODO: Append your new element to the page
  fruitNames.map(name => exampleAddElement(name));

}

// SAMPLE CODE of how to create and append a new HTML element to the page
const exampleAddElement = (name) => {
